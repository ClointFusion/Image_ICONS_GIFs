            ...
            class Video extends elementorModules.frontend.handlers.Base {
                ...
                playVideo() {
                    ...
                    const e = this.elements.$videoIframe,
                        t = e.data("lazy-load");
                    t && e.attr("src", t);
                    const s = e[0].src.replace("&autoplay=0", "");
                ...
                onInit() {
                    super.onInit();
                    const e = this.getElementSettings();
                    if ("youtube" === e.video_type && (this.apiProvider = elementorFrontend.utils.youtube, this.videoID = this.apiProvider.getVideoIDFromURL(e.youtube_url), this.videoID && (!e.show_image_overlay || !e.image_overlay.url))) return e.lazy_load ? (this.intersectionObserver = elementorModules.utils.Scroll.scrollObserver({
                        callback: e => {
