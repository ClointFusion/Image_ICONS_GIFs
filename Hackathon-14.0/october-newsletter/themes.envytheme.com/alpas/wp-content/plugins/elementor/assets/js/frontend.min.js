    ...
    [819], {
            ...
            class Frontend extends elementorModules.ViewModule {
                ...
                initOnReadyComponents() {
                    this.utils = {
                        ...
                        anchors: new b,
                        get lightbox() {
                            return u.default.getLightbox()
                        },
                        urlActions: new l.default,
                        swiper: c.default,
                        environment: r.default,
                        assetsLoader: new h.default,
                ...
                init() {
                    this.hooks = new f, this.breakpoints = new g.default(this.config.responsive), this.storage = new o.default, this.elementsHandler = new v(jQuery), this.modulesHandlers = {}, this.addUserAgentClasses(), this.setDeviceModeData(), this.initDialogsManager(), this.isEditMode() && this.muteMigrationTraces(), this.elements.$window.trigger("elementor/frontend/init"), this.initModules(), this.initOnReadyElements(), this.initOnReadyComponents()
                }
                onDocumentLoaded() {
                    this.documentsManager = new s.default, this.trigger("components:init"), new u.default
                }
            }
        ...
        6397: (e, t) => {
            ...
            class GlobalHandler extends elementorModules.frontend.handlers.Base {
                ...
                onInit(...e) {
                    super.onInit(...e), this.getAnimation() && elementorFrontend.waypoint(this.$element, (() => this.animate()))
                }
                onElementChange(e) {
